    ...
    public function up()
    {
        Schema::create('blogs', function (Blueprint $table) {
           $table->increments('id');
            ...
            $table->foreign('parent_id')->references('id')->on('blogs')->onUpdate('cascade')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('lang_id')->references('id')->on('blogs')->onUpdate('cascade')->onUpdate('cascade')->onDelete('cascade');
