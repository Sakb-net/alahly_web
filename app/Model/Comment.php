...
class Comment extends Model {
    ...
    public function parentOneID() {
        return $this->hasMany(\App\Model\Comment::class, 'parent_one_id');
    }

    public function childrenstwo() {
        return $this->hasMany(\App\Model\Comment::class, 'parent_two_id');
    }

    public function parentID() {
        return $this->belongsTo(\App\Model\Comment::class, 'parent_one_id');
    }

    public function childrensID() {
        return $this->belongsTo(\App\Model\Comment::class, 'parent_two_id');
    }
