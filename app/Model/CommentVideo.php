...
class CommentVideo extends Model {
    ...
    public function videos() {
        return $this->belongsTo(\App\Model\Post::class,'video_id');
    }
    ...
    public function parentOneID() {
        return $this->hasMany(\App\Model\CommentVideo::class, 'parent_one_id');
    }

    public function childrenstwo() {
        return $this->hasMany(\App\Model\CommentVideo::class, 'parent_two_id');
    }

    public function parentID() {
        return $this->belongsTo(\App\Model\CommentVideo::class, 'parent_one_id');
    }

    public function childrensID() {
        return $this->belongsTo(\App\Model\CommentVideo::class, 'parent_two_id');
    }
