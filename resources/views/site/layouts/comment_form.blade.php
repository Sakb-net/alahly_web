<div class="comments-form">
    ...
    <form role="form" data-validate="parsley"  action=""  method="post" enctype="multipart/form-data"> 
        ...
        <!-- Form row end -->
        <div class="clearfix">
            <button class="butn butn-bg add_post_user_message"  data-link='{{$data->link}}' id="add_post_user_message" type="submit" data-type="{{$type}}"><span>إرسال التعليق</span></button> 
        </div>
    </form>
    <!-- Form end -->
</div>