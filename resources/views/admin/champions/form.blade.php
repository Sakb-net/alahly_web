        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('parent_id',$teams ,$cat_teams, array('class' => 'select select2 ajax_get_subteam','required'=>'')) !!}
                </div>
                @include('admin.champions.ajax_get_subcategory')
